...
const char *valorAtributosMeshes[] =  {"0 1 0 1","3","Triangle","Group_0","3"};    
...
void distAtributos(const char *estruturas[], const char **atributos[],const char **valorAtributos[], int iteracoesTotais, int * tamanhos, double coords[4][9], int elements[6][8], int results[4][9]) 
{   
    ...
    int numColsElementsQ, numColsElementsT; 
    ...
    if (countT!=0)
    {
        ...
        for (int i = 0; i < numColsElements; i++)
        {   
            if (elements[4][i]!=1) {indexT[countIndexT] = i;countIndexT++;}
        }  
    ...
    for (int j = 0; j < iteracoesTotais; j++)
    {
        ...
        {   
            ...
            else if (strcmp(valorAtributos[0][2],"Mix")==0)
            {
                ...
                // Datasets para as incidências dos elementos 
                elements_dataspace = H5Screate_simple(1, (hsize_t[]){numColsElementsT}, NULL);   
                hsize_t dims_elementsTri[2] = {3, countT};
...
int main() {
    ...
    int elements [6][8] = { /*indice de cada elemento*/         {1,2,3,4,5,6,7,8},
                            /*indice 1 do nó de cada elemento*/ {1,1,2,2,4,4,5,5},
                            /*indice 2 do nó de cada elemento*/ {5,2,6,3,8,5,9,6},
                            /*indice 3 do nó de cada elemento*/ {4,5,5,6,7,8,8,9},
                                                                {0,0,0,0,0,0,0,0},
