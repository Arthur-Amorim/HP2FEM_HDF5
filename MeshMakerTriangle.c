...
void distAtributos(const char *estruturas[], const char **atributos[],const char **valorAtributos[], int iteracoesTotais, int * tamanhos, double coords[4][9], int elements[5][8], int results[4][9]) 
{   
...
int main() {
    ...
    int elements [5][8] = { /*indice de cada elemento*/         {1,2,3,4,5,6,7,8},
